...
module.exports = { 
  main: async function (event, context) {
    ...
    var payment_config = {
      method : 'post',
      url : 'http://orchestrator.sit-r2-payment.tatadigital.com/orch/payment/status',
      headers : {
    ...
    .then(function(response) {
      ...
      if (payment_status === "failed") {
        ...
        var cart_config = {
          method : 'get',
          url : 'http://caas.sit-2-uc.tatadigital.com/carts/fetchCartDetails',
          headers : {
        ...
        .then(function (response) {
          ...
          var promise_config = {
            method : 'post',
            url : 'http://inventory.sit-2-uc.tatadigital.com/promise',
            headers : {
              "X-ProgramID" : headers['x-programid'],
              "Content-Type" : "application/json"
            },
          ...
          .then(function (response) {
            ...
            if (promise_status === 0) {
              ...
              var deleteCart_config = {
                method : 'post',
                url : 'http://caas.sit-2-uc.tatadigital.com/carts/deleteCloneCart',
                headers : {
                  "X-ProgramID" : headers['x-programid'],
              ...
              .then(function (response) {
                ...
                if (deleteCart_status === 400) {
                  ...
                  var order_config = {
                    method : 'post',
                    url : 'http://orders.sit-2-uc.tatadigital.com/api/v2/order',
                    headers : {
                      "X-ProgramID" : headers['x-programid'],
